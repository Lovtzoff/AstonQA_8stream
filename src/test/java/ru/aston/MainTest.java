...
public class MainTest {
    ...
    public void testGetFactorialWithNegativeInput() {
        int input = -1;
        Main.getFactorial(input); // Исключение будет выброшено
    }
    ...
    public void testGetFactorialWithLargeInput() {
        int largeInput = 21;
        Main.getFactorial(largeInput); // Исключение будет выброшено
    }
    ...
    public void testGetFactorialWithString(Object input) {
        Main.getFactorial((Integer) input); // Исключение будет выброшено
    }
}